...
class Cnn(nn.Module):
    def __init__(
            self,
            channels=[24, 128, 128, 128, 128],  # big channels 
    ):
        """
        ...
        self.conv1 = Spatblock_spilt(16, channels[0])
        self.conv2 = Spatblock_spilt(channels[0], channels[1])
        self.conv3 = Spatblock_spilt(channels[1], channels[2])
        self.conv4 = Spatblock_spilt(channels[2], channels[3])
        self.conv5 = Spatblock_spilt(channels[3], channels[4])
        self.conv6 = Spatblock_spilt(channels[4], channels[5])
